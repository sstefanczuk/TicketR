    ...
    public static class Extensions
    {
            ...
            string serviceName, RestEaseOptions options)
        {
            services.AddHttpClient(clientName, client =>
            {
                ...
                if (service == null)
                {
                    throw new ApplicationException($"RestEase service: '{serviceName}' was not found.");
                }
        ...
        private static RestEaseOptions ConfigureOptions(IServiceCollection services)
        {
            ...
            var restEaseOptions = new RestEaseOptions();
            configuration.GetSection("restEase").Bind(restEaseOptions);
